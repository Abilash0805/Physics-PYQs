  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        green: "border-transparent bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-200",
        purple: "border-transparent bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-200",
        amber: "border-transparent bg-amber-100 text-amber-700 dark:bg-amber-900 dark:text-amber-200",
